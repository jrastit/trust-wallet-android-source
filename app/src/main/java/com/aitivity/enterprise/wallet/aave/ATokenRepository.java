...
public class ATokenRepository implements ATokenRepositoryType{
    ...
    public Single<String> getExchangeRate(Wallet from
        ...
        ATokenWeb3 aTokenWeb3 = new ATokenWeb3(web3j, kovan_addresse, transactionManager, contractGasProvider, networkRepository, accountKeystoreService, transactionLocalSource, blockExplorerClient);


        return Single.fromCallable(() -> {
            Uint256 ret = aTokenWeb3.getExchangeRate().send();
